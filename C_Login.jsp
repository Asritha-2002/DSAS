    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="C_Login.jsp">ADMIN</a></li>
        </ul>
      </div>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form action="C_Authentication.jsp" method="post" id="leavereply">
            ...
            Name&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; </span></label>
            <span class="style4">
            <input name="userid" type="text" class="box" id="name" value="" placeholder="enter username"/>
            <label for="email"><br />
            <br />
            Password </label>
            </span>
            ...
            <label for="email"> &nbsp;&nbsp; </label>
            <input type="password" id="pass" name="pass" class="box" placeholder="enter password"/>
            <p>&nbsp;</p>
            <p>
