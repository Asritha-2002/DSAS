    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="C_Login.jsp">CLOUD SERVER(Admin)</a></li>
        </ul>
      </div>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form action="U_RegisterAuthentication.jsp" method="post" id="" enctype="multipart/form-data">
            <label for="name"> <br />
              <span class="style4">User Name<br />
            </span></label>
            <p class="style4">
            ...
            <span class="style4">
            <label for="mobile">Mobile Number<br />
            </label>
            </span>
            <p class="style4">
            ...
            <span class="style4">
            <label for="gender">Select Gender<br />
            </label>
            </span>
            <p class="style4">
            ...
            <span class="style4">
            <label for="pincode">Enter Pincode<br />
            </label>
            </span>
            <p class="style4">
            ...
            <span class="style4">
            <label for="location">Enter Location<br />
            </label>
            </span>
            <p class="style4">
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="C_Login.jsp">Admin</a></li>
