...
<div class="main">
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Welcome to <%=application.getAttribute("doname")%></h2>
          <p class="infopost">&nbsp;</p>
          <div class="style2"></div>
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu style4">
            <li><a href="O_Main.jsp">Home</a></li>
			 <li><a href="O_Upload_Datasets.jsp">Upload</a></li>
			  <li><a href="O_View_All_Uploaded_Datasets.jsp">View All Uploaded Data</a></li>
