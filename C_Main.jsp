      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><strong><a href="C_UserAutho.jsp">View and Authorize User</a></strong></li>
            <li><strong><a href="C_OwnerAutho.jsp">View and Authorize  Owner</a></strong></li>
			
			<li><strong><a href="C_View_All_Datasets.jsp">View All Data</a></strong></li>
			
			
		
			
			<li><strong><a href="C_View_Disease_Results.jsp">View Disease Results</a></strong></li>
